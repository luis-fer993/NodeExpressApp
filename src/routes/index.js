...
router.get('/',(req,res)=>{
    ...
    res.render('index.html', { title: 'Bienvenido a mi pagina', query : req.query.name }); //renderiza el archivo index.html que esta en la carpeta views y le envia un objeto con el titulo 
})
